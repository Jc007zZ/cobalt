...
import donwarrow from '../assets/icons/donwarrow.svg'
    ...
    <div className="bg-black overflow-x-hidden">
      <header >
        ...
        <nav className="w-full h-10 flex justify-between items-center sm:px-10 px-6  xl:px-56 pt-8">
          <div className='font-bold flex items-center gap-x-1 logoShadow'>
            <img src={logo} alt="" />
              Cobalt
          </div>
          
          <div className="flex gap-6">
            <p className=' text-gray-300 flex items-center hover:scale-105 hover:cursor-pointer transition-all'>Blog</p>
            <JoinButton/>
          </div>
        </nav>
        ...
        <section className=' mt-36 flex flex-col gap-14'>
            ...
            <article className='flex justify-center gap-8 flex-wrap'>
                ...
                <div className='askCard bg-zinc-950 rounded-xl border border-zinc-800 flex flex-col items-end flex-1 gap-6 p-4'>
                    ...
                    <div className='w-full flex items-center justify-between bg-zinc-900 px-4 py-2 rounded-xl border border-slate-700/40 '>
